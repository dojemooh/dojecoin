...
CBigNum bnProofOfWorkLimit(~uint256(0) >> 2); // "standard" scrypt target limit for proof of work, results with 0,000244140625 proof-of-work difficulty
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DojeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	block.print();
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xce4f4206e46ba06c270e852f36fc3a82488e4a17de899dd400c6f016277229d3"));
        block.print();
